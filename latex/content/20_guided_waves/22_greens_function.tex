...
Each component of $\mathbf{J}$ drives a combination of components in $\mathbf{A}$. Dyadics capture this component-wise coupling and simplify the notation \cite[p. 92]{Collin_2015}.\todo[inline]{Note: Chapter is called "Guided Waves", but this chapter presents free-space solutions}
