...
monopole antenna, the Chu equivalent circuit for a short electric 
dipole \cite{Hansen_Collin_2013} is applied, as demonstrated in 
...
\begin{figure}[h]
	...
	\resizebox{0.25\textwidth}{!}{
		\begin{tikzpicture}
			...
			at (8.534, 7.75){} node[anchor=north west, align=left, 
			text width=1.827cm, inner sep=6pt] at (7.409, 8.25){$P_{in}$};
		\end{tikzpicture}
	}
	\caption{The Chu equivalent circuit for a short electric dipole models 
...
\begin{figure}[htbp]
	...
	\resizebox{\textwidth}{!}{%
		\begin{tikzpicture}
			...
			(N1) at (2.5, 10){} node[anchor=east] at (N1.west){$P_\mathrm{in}$};
			\node[ground] at (2.5, 8){};
			\draw (2.5, 8) -| (2.5, 9.5);
			...
			dash pattern={on 4pt off 4pt}, minimum width=4.965cm, 
			minimum height=5.715cm] at (8.5, 9.875){};
