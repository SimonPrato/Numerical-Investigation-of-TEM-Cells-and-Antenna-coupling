...
\begin{figure}[htbp]
	...
	\resizebox{0.7\textwidth}{!}{%
		\begin{tikzpicture}
			...
			\node[circ] at (11, 7){};
			\node[circ] at (4, 7){};
			\node[shape=rectangle, minimum width=2.465cm, minimum height=0.715cm] at (12.75, 7.375){} node[anchor=north west, align=left, text width=2.077cm, inner sep=6pt] at (11.5, 7.75){output port 2};
			\node[shape=rectangle, minimum width=2.465cm, minimum height=0.715cm] at (2.5, 7.375){} node[anchor=north west, align=left, text width=2.077cm, inner sep=6pt] at (1.25, 7.75){output port 1};
		\end{tikzpicture}
	}
