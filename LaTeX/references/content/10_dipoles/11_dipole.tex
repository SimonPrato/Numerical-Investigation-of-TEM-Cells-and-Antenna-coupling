...
\begin{equation}
	\mathbf{A}(\mathbf{x})=\frac{\mu}{4\pi}\frac{\mathrm{e}^{-jkr}}{r}\iiint_V \mathbf{J}(\mathbf{x'})\,d\mathbf{x'}.
...
\begin{equation}
	\mathbf{p} = \iiint_V\mathbf{x'} \rho (\mathbf{x'})\,d\mathbf{x'}.
...
\begin{equation}
    \mathbf{m}=\frac{1}{2}\iiint_V (\mathbf{x'} \times \mathbf{J})\,d\mathbf{x'}.
...
\begin{equation}
	\oint_C \mathbf{H} \cdot d\mathbf{C}' = I_f + \epsilon \frac{\partial \phi}{\partial t} 
\end{equation}
