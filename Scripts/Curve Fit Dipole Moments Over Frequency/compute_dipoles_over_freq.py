...
print(f"Electric Dipole Moments fitted parameters: {a_e} * freq ^ 2 + {b_e} * freq + {c_e}")
print(f"Magnetic Dipole Moments fitted parameters: {a_m} * freq ^ 2 + {b_m} * freq + {c_m}")
