...
Different volumes of interest $V_1$, $V_2$, $...$, $V_n$ can be connected by applying boundary conditions on their surrounding surfaces $S_1$, $S_2$, $...$, $S_n$. Applying Green's second identity on the Poisson's equation enables enforcing such a boundary condition upon the surrounding surface $S$ of a volume $V$, 
...
is more suitable for three-dimensional problems. It relates a vector source with a vector response, which is necessary when solving the vector Helmholtz equation in 
