...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.7\linewidth]{content/10_theory/img/vertical_antenna_tem_cell}
...
The perturbed term in \autoref{eqn:perturbed_green} describes the influence of a point source on the gaps. The functions used are,
