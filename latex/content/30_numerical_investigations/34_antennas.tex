...
\begin{equation}
	...
	\label{sec:ampere_law_fem}
\end{equation}

A fine mesh resolution, as discussed in \autoref{sec:mesh}, is important for accurate results delivered by \autoref{sec:ampere_law_fem}. 
