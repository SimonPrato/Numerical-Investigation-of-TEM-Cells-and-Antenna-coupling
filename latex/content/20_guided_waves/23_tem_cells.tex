...
\todo[inline]{TODO: This section talks about the radiation resistance of an antenna in TEM cell. Take the equations of the TEM mode in the same reference paper instead.}

Opposed to the rectangular waveguide, a TEM cell conducts TEM waves. 
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.7\linewidth]{content/img/tem_cell_modes.png}
...
\begin{table}[h]
	...
	\begin{tabular}{|c|c||c|c|}
		...
		\hline
	\end{tabular}
	\caption{Cut-off frequencies of higher order modes at different TEM cell dimensions.}
