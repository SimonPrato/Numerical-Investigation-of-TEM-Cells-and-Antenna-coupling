...
The conductors adjacent to the gap act as capacitor plates, accumulating charges on both sides. These charges generate a displacement current that flows back toward the feed point and constitutes a major contribution to the electric energy stored by the antenna. As a secondary effect, the accumulated charges modify the antenna potential, thereby increasing the displacement current toward the septum. According to \eqref{eqn:me_i}, this results in electric coupling to the septum and consequently induces an electric dipole moment $\mathbf{m}_e$.
