...
\begin{equation}
	I_m L = j\omega\mu_0 A I_0,
	\label{eqn:magn_current_curr_loop}
\end{equation}

so that the infinitesimal magnetic current element $I_m L$ and the electrically small 
current loop $I_0$ are equivalent representations producing identical electric and 
