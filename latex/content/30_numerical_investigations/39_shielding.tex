...
Empty square aperture with side length of $d=11.2\,\mathrm{mm}$ used. Materials filling the aperture have a thickness of $t=10\,\upmu\mathrm{m}$. Simulation model leans on measurement setup in \cite{4091811}.

\begin{figure}[htbp]
	\centering
	\begin{subfigure}[b]{0.48\textwidth}
		\centering
		\includegraphics[width=1\linewidth]{content/img/polyester_aperture}
		\caption{Polyester}
		\label{fig:polyesteraperture}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.48\textwidth}
		\centering
		\includegraphics[width=1\linewidth]{content/img/nickel_aperture}
		\caption{Nickel}
		\label{fig:nickelaperture}
	\end{subfigure}
	\caption{The forward transmission S-parameters of port 1 to ports 3 and 4 $|S_{13}|$, $|S_{14}|$ for different shielding materials filling the aperture. }
	\label{fig:example}
\end{figure}
