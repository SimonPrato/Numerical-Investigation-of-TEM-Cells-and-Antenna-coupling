...
to the feedpoint, giving rise to reflected power. The shielding material thus interacts 
...
rotational with no feedpoint to which they can return. Consequently, the interaction 
between the source and the shielding material is neglected in the dipole model.
