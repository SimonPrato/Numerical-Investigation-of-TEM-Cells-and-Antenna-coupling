...
While the scalar Green’s function is useful for solving one-dimensional differential equations, the dyadic Green’s function $\mathbf{\hat G}$
...
When replacing $\mu \mathbf{J}$ by an unit vector source $\left(\mathbf{\hat{a}}_x + \mathbf{\hat{a}}_y + \mathbf{\hat{a}}_z\right)\delta(\mathbf{x}-\mathbf{x'})$, the solution for $\mathbf{A}$ of \autoref{eqn:helmholtz} is  

\begin{equation}\label{eqn:sol_dyadic_green}
	\mathbf{A} = (\mathbf{\hat{a}}_x + \mathbf{\hat{a}}_y + \mathbf{\hat{a}}_z) \frac{e^{-j k |\mathbf{x} - \mathbf{x'}|}}{4\pi |\mathbf{x} - \mathbf{x'}|}.
\end{equation}
...
\begin{align}
	\nonumber\mathbf{\hat{G}}=&G_{xx}\,\mathbf{\hat{a}}_x\otimes\mathbf{\hat{a}}_x+G_{xy}\,\mathbf{\hat{a}}_x\otimes\mathbf{\hat{a}}_y + G_{xz}\,\mathbf{\hat{a}}_x\otimes\mathbf{\hat{a}}_z+\\\nonumber
	&G_{yx}\,\mathbf{\hat{a}}_y\otimes\mathbf{\hat{a}}_x+G_{yy}\,\mathbf{\hat{a}}_y\otimes\mathbf{\hat{a}}_y + G_{yz}\,\mathbf{\hat{a}}_y\otimes\mathbf{\hat{a}}_z+\\\nonumber
	&G_{zx}\,\mathbf{\hat{a}}_z\otimes\mathbf{\hat{a}}_x+G_{zy}\,\mathbf{\hat{a}}_z\otimes\mathbf{\hat{a}}_y + G_{zz}\,\mathbf{\hat{a}}_z\otimes\mathbf{\hat{a}}_z
\end{align}
...
The solution of any current distribution $\mathbf{J}$ can be obtained by superposition, analogous to the scalar Green's Function. 
