...
In this section, the regions of the electromagnetic fields contributing to the coupling between the antenna and the TEM cell are analyzed using the model presented in \autoref{fig:krtemcell}. This model consists of a TEM cell and two dipole moments. It is assumed that the coupling occurs in the near-field region ($k \cdot r \ll 1$). Any deviation from this condition could affect the simulation results and the derived equivalent dipole moments of the antenna. By varying the size of the TEM cell and observing the corresponding changes in output power over frequency, it is possible to determine whether the output power depends on the dominant coupling field region within the frequency range of interest.
