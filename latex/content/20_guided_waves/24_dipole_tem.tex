...
\todo[inline]{Move the following to equations to a better position with a nice explanation.}
...
\todo[inline]{Explain why output power rises quadratically and moments linearly over f if U and I are kept constant}
