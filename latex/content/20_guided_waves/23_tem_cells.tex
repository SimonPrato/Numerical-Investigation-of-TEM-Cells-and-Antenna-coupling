...
\todo[inline]{TODO: Unvollendetes Kapitel. Es soll die Ausbreitung des TEM Modes in der TEM Zelle durch \cite{Tippet_Chang_Crawford_1976,Wilson_1981} erklärt werden.}

Opposed to the rectangular waveguide, a TEM cell conducts TEM waves. The TEM mode is necessarily excited by the geometry of the TEM cell, hence this mode is called essential. The higher order TE and TM modes, which are only excited due to non-uniformity of the TEM cell, are called non-essential modes \cite{990711}.
