...
columns_phase_shift, columns_magnitude = read_csv(antenna_type="serial_loop")
...
plot_phase_shift(columns_phase_shift, frequencies)

m_e, m_m = calculate_moment(e_field_approx, phase_shift, output_power, frequencies)
plot_moments(m_e, m_m, frequencies)
