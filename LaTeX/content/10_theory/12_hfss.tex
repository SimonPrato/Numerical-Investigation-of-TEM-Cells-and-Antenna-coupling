...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.25\linewidth]{content//10_theory/img/tetrahedra_w_unknowns.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.75\linewidth]{content//20_antennas//img/workflow_fem.png}
