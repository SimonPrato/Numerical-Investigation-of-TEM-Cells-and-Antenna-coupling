...
Reflections contribute most significantly to a material’s shielding effectiveness \cite[p. 1]{Jaroszewski_Thomas_Rane_2019}. They are characterized by the reflection coefficient $R$. Highly conductive materials, such as metals, reflect the majority of incident electromagnetic waves. The same is true for materials with high permittivity or permeability. 
...
Upon reaching the other end of the shielding material, re-reflections can occur. However, when investigating shielding materials with thicknesses less than the skin depth, the correction factor for this effect $B_{\mathrm{dB}}$ can be neglected \cite[p. 1]{Jaroszewski_Thomas_Rane_2019}.
