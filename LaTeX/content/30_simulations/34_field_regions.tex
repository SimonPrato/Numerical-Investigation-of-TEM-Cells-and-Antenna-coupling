...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.7\linewidth]{content/30_simulations/img/kr_tem_cell}
...
\begin{figure}[htbp]
	...
	\centering
\includegraphics[width=1\linewidth]{content/30_simulations/img/loop_small_tem_moments.png}
...
\begin{figure}[htbp]
	...
	\begin{minipage}[t]{0.48\textwidth}
	\centering
	\includegraphics[width=1\linewidth]{content/30_simulations/img/kr_analysis_small_TEM}
	...
	\begin{minipage}[t]{0.48\textwidth}
	\centering
	\includegraphics[width=1\linewidth]{content/30_simulations/img/kr_analysis}
...
The power transferred to the output is shown in \autoref{fig:outputpowerdipoleloopsmalltem}. One trace shows the output power of the current loop, the other one of equivalent dipole moments imitating the traces in \autoref{fig:loop_small_tem_moments}. The magnitude of the maximum power is normalized to 1\,W to compare the plots qualitatively. Both quantities behave exactly the same. This indicates, that the non-linear dipole moment behavior over frequency is not the product of the coupling behavior to the TEM cell, but truly caused by the antenna's geometry. \todo{compare phases}

\begin{figure}[h]
	\centering
	\includegraphics[width=0.7\linewidth]{content/30_simulations/img/output_power_dipole_loop_small_tem}
	\caption{Output power of the loop antenna in the small TEM cell and of the equivalent dipole moments}
	\label{fig:outputpowerdipoleloopsmalltem}
\end{figure}
