...
The shielding material is modeled as a thin sheet of thickness $10\,$µm, 
positioned at the center of the TEM cell at $z = 0$. To reduce computational cost, 
the sheet is represented using impedance boundary conditions, which are an 
accurate representation for this material thickness as discussed in \cref{sec:bc-shield}. 
The ASTM ES7-83 method requires the definition of a reference power $P_\mathrm{ref}=1\,\mathrm{W}$ to evaluate the shielding effectiveness according to \eqref{eqn:SE_power}. The 
...
shielding effectiveness is presented against frequency in \autoref{fig:se-barrium-ferrite}.
