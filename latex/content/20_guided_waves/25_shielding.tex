...
An electromagnetic wave can undergo multiple reflections within the shielding material, with each reflection contributing to the total reflected, absorbed, and transmitted wave. The total shielding effectiveness is determined by
...
Reflections are caused by changes in wave impedance and are characterized by the reflection coefficient $R$. It is common practice to normalize the wave impedance $Z$ to the free-space wave impedance $Z_0$. At the interface between free space and a shielding material, this yields \cite{Collin_2015}
...
Electric fields dominate in the near-field region of electric dipoles, as discussed in \cref{sec:ele_dip}. Effective shielding in this case requires materials with high permittivity and high conductivity, ideally featuring a high electric loss tangent $\tan\delta_e$. In contrast, magnetic fields are predominant in the near-field region of magnetic dipoles (see \cref{sec:mag_dip}). Shielding and redirecting magnetic fields require materials with high permeability and conductivity, again with a high magnetic loss tangent $\tan\delta_m$ shall be used.\todo{source}
