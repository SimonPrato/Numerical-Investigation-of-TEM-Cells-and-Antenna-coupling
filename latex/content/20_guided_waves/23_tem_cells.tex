...
\begin{figure}[bt]
	...
	\caption{The Green's function solves the fields in the cross section surface $S$ of the TEM cell, which is colored in light gray and bounded by $l$. The source exciting these fields is a centered, electric dipole moment $\mathbf{m}_e$.}
